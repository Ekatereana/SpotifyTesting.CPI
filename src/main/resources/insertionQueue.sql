...
values 
(1,'Seсorita','Shawn Mendes','canadian pop',117,55,76,-6,8,75,191,4,3,79),
(2,'China','Ahttp://127.0.0.1:51919/datagrid/panel/1645536?is_query_tool=true&sgid=1&sid=1&server_type=pg&did=85267#nuel AA','reggaeton flow',105,81,79,-4,8,61,302,8,9,92),
...
(6,'I Dont Care (with Justin Bieber)','Ed Sheeran','pop',102,68,80,-5,9,84,220,9,4,84),
...
(17,'LA CANCIУN','J Balvin','latin',176,65,75,-6,11,43,243,15,32,90),
...
(26,'If I Cant Have You','Shawn Mendes','canadian pop',124,82,69,-4,13,87,191,49,6,70),
(27,'Dance Monkey','Tones and I','australian pop',98,59,82,-6,18,54,210,69,10,83),
(28,'Its You','Ali Gatie','canadian hip hop',96,46,73,-7,19,40,213,37,3,89),
...
(40,'fuck, im lonely (with Anne-Marie) - from 13 Reasons Why: Season 3','Lauv','dance pop',95,56,81,-6,6,68,199,48,7,78),
...
(45,'Con Altura','ROSALНA','r&b en espanol',98,69,88,-4,5,75,162,39,12,88),
(46,'One Thing Right','Marshmello','brostep',88,62,66,-2,58,44,182,7,5,88),
(47,'Te Robarй','Nicky Jam','latin',176,75,67,-4,8,80,202,24,6,88),
...
select s.id, s.track_name, s.artist_name, s.genre  from spotify_data as s
